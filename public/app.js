const App = {
    ...
    renderTabla: () => {
        ...
        tbody.innerHTML = filtrados.map(t => {
            ...
            if(t.foto_url) {
                ...
                else iconoFile = `<a href="${t.foto_url}" target="_blank">📷</a>`;
            }
    ...
    exportarCSV: () => { let csv = "Matricula,Ubicacion,Nombre,Tipo,Familia\n"; App.datos.forEach(t => csv += `${t.id_troquel},${t.ubicacion},${t.nombre},${App.mapaCat[t.categoria_id]},${App.mapaFam[t.familia_id]}\n`); const a = document.createElement('a'); a.href = 'data:text/csv;charset=utf-8,' + encodeURI(csv); a.download = 'inventario.csv'; a.click(); }
};
