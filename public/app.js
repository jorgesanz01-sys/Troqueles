const App = {
    ...
    init: async () => {
        console.log("Iniciando ERP V13 (RESCATE)...");
        // ORDEN CRÍTICO: 1. Selects, 2. Datos
    ...
    cargarTodo: async (papelera = false) => {
        try {
            ...
            if(res.ok) {
                ...
                App.renderTabla(); // AQUÍ SE USA EL DICCIONARIO
    ...
    cargarSelects: async () => {
        try {
            ...
            // CONSTRUIR EL MAPA DE TRADUCCIÓN ID -> NOMBRE
            ...
            const llenar = (id, data) => {
                ...
                if(el) {
                    ...
                    if(prev) el.value = prev; // Intentar mantener selección
                }
            };
    ...
    // --- RENDER TABLA (AQUÍ ESTÁ EL ARREGLO DE NOMBRES) ---
    renderTabla: () => {
        ...
        let filtrados = App.datos.filter(t => {
            ...
            // Comparación laxa (==) para que '5' (string) coincida con 5 (int)
        ...
        filtrados.sort((a, b) => {
            ...
            // Ordenar por nombre real si es familia/tipo
        ...
        tbody.innerHTML = filtrados.map(t => {
            ...
            // Buscamos el nombre. Si no está, pero tiene ID, lo ponemos en rojo.
    ...
    crearFamilia: async () => {
        ...
        if(res.ok) { 
            ...
            await App.cargarSelects(); 
            // La API devuelve array, cogemos el primer elemento
    ...
    toggleScanner: (show=true) => {
        ...
        if(show) {
            ...
            App.scanner.start({facingMode:"environment"}, {fps:10, qrbox:250}, (txt) => {
                // BLOQUEO 3 SEGUNDOS PARA EVITAR LECTURAS INFINITAS
